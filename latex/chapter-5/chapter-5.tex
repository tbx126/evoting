...
\midrule
\texttt{Voting} & 7{,}637 bytes (7.5 KB) & Main election logic; largest contract \\
...
The total deployed bytecode across all five contracts is 15{,}485 bytes. The Voting contract is the largest at 31\% of the EIP-170 limit, leaving substantial headroom for additional features if needed. The Groth16 verifier contracts are compact because snarkjs generates optimized inline pairing-check code.
