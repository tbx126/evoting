...
\midrule
\texttt{Voting} & 8{,}498 bytes (8.3 KB) & Main election logic; largest contract \\
...
The total deployed bytecode across all five contracts is 16{,}346 bytes. The Voting contract is the largest at 35\% of the EIP-170 limit, leaving substantial headroom for additional features if needed. The Groth16 verifier contracts are compact because snarkjs generates optimized inline pairing-check code.
