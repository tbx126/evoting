...
\begin{itemize}
    ...
    \item a voter verification path where inclusion can be checked from local receipts without address lookup during verification.
\end{itemize}
...
\begin{itemize}
    ...
    \item a receipt-based path to confirm ballot inclusion---just a receipt and a Merkle proof, without additional identity disclosure in the verification step;
...
RQ2 & Comparative verifiability gain over centralized e-voting & Chapter 2 positioning (Table \ref{tab:approach-comparison}) and Chapter 5 security analysis \\
