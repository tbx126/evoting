...
RQ3 & Gap analysis between functional completion and high-assurance completion & Chapter 5 outstanding gaps and Appendix~\ref{tab:acceptance-checklist} checklist \\
\bottomrule
\end{tabular}
\end{table}
