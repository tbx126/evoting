...
\begin{enumerate}
    ...
    \item \textbf{Candidate-count alignment}: enforce candidate count constraints at contract level or support per-election circuit generation and verifier deployment.
...
Mid-term & Candidate-count/circuit alignment, lifecycle-gated Merkle root governance, deployment hardening & Reduce misuse risk and improve operational robustness \\
