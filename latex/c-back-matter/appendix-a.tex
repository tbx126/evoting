...
Before running the frontend flow, ensure the following files exist under \texttt{frontend/zk/}:
\begin{itemize}
...
\end{itemize}
These artifacts are not committed to the repository and must be generated or provisioned separately. They must match the deployed verifier contracts; otherwise proof generation or on-chain verification will fail.
