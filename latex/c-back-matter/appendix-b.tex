...
\begin{enumerate}
    ...
    \item \textbf{[P1]} Compare audit bundle root with on-chain \texttt{merkleRoot} during voter verification.
    \item \textbf{[P2]} Align candidate cardinality between circuits and contract logic.
    \item \textbf{[P2]} Lifecycle-gate or remove unrestricted Merkle-root overwrite operation.
\end{enumerate}
