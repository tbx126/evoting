...
\AtBeginEnvironment{equation*}{\setstretch{1}}            % single spacing for unnumbered equations
\AtBeginEnvironment{align}{\setstretch{1}}                % single spacing for align equations
\AtBeginEnvironment{align*}{\setstretch{1}}               % single spacing for unnumbered align
\AtBeginEnvironment{gather*}{\setstretch{1}}              % single spacing for unnumbered gather
\AtEndEnvironment{equation}{}                             % restore after equation
\numberwithin{equation}{chapter}                          % equation numbering follows chapter
\renewcommand{\theequation}{\thechapter.\arabic{equation}}% display as 2.1 / A.1
...
% Custom "Page" column header, right-aligned (per NTU guideline Appendix 6)
\renewcommand{\cftaftertoctitle}{%
    \vspace{-1.5\baselineskip} % reduce space after Table of Contents
    \hfill\underline{Page} % right-aligned
    \par\vskip-2\baselineskip % adjust spacing
}
% TOC formatting
% Chapter level
\renewcommand{\cftchapfont}{\bfseries}                  % bold chapter titles
\renewcommand\thesection{\thechapter.\arabic{section}} % section numbering follows chapter style
...
\renewcommand{\cftsecdotsep}{\cftnodots}                % no dot leaders for sections (per NTU template)
\renewcommand{\cftsecpagefont}{\color{white}}           % hide section page numbers (per NTU template)
% Spacing
...
\titleformat{\chapter}[display]            % "Chapter 1" on separate line
  ...
  {\chaptername\enspace\thechapter}        % shows "Chapter 1" / "Appendix A"
  {0em}                                    % space between number and title
  {\raggedright}                           % title left-aligned
% Unnumbered \chapter* (Abstract, Lists, etc.)
...
\addtocontents{toc}{\protect\renewcommand{\protect\cftchappresnum}{Appendix\enspace}}
\addtocontents{toc}{\protect\setlength{\protect\cftchapnumwidth}{8.3em}}
